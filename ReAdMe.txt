Project:	qbd Enhanced Printer Control with Preview 1.6.0
...
LICENSE AGREEMENT.
Code is provided AS IS.  We accept no liability.  'qbd' 'qbd software'
'edward moth' and 'moth' are highly respected words that should not
be removed from any of our files.  We retain all intellectual copyright.
...
SEE WEBSITE www.qbdsoftware.co.uk/moth
...
WARRANTIES:
All code is provided 'as is', without warranties of any kind
whatsoever, even if it is expressed or implied.

LIABILTY:
qbd software ltd and edward moth accept no liability whatsoever even
if you are an Arsenal supporter - that's your fault not ours.   By
using this code you accept that Manchester United are the greatest
